  ...
  return (
    <div className="lg:mt-40 mb-40 mt-20 ">
      <div className="container">
        <h1
          className="w-full font-[700] text-[37.34px] leading-10 text-center"
          data-aos="zoom-in"
        >
          How it works?
        </h1>
        <div className="flex justify-center mt-8 mb-16">
          <p
            data-aos="zoom-in"
            className="md:w-[839px] font-[400] md:text-[17.16px] text-[14px] leading-7 text-center"
          >
         ...
         {/*Some design is written with pure css like the odd background selection*/}
        <div>
          <ul className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
            {gridData.map((items) => (
              <li
                data-aos="zoom-in"
                className="h-[254px] odd-bg-color flex flex-col gap-5 justify-center items-center"
              >
                ...
                <p className="font-[500] text-center leading-7">
                  {items.content}
                </p>
              </li>
            ))}
